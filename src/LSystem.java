...
public class LSystem {
    ...
    /**
     * Removes any unrecognized characters in the input String
     *
     * @param begin Input string to be generated
     * @return Final sentence with unrecognized characters removed
     */
    public String valid(String begin){
        char comp;
        StringBuilder finalStr = new StringBuilder();
        // loops traverse through input string
        for(int i = 0; i < begin.length(); i++){
            comp = begin.charAt(i);
            // checks validity of characters in String
